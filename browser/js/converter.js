...
require.define("/author/sequences.js", function (require, module, exports, __dirname, __filename) {
  ...
  Sequence.classFor['MultipleChoiceWithCustomHintsSequence'] = MultipleChoiceWithCustomHintsSequence = (function() {
    ...
    MultipleChoiceWithCustomHintsSequence.prototype.getCriterionForCorrectAnswer = function() {
      return this.getCriterionForChoice(this.correctAnswerIndex);
    };
    ...
    MultipleChoiceWithCustomHintsSequence.prototype.appendSteps = function(runtimePage) {
      var addPanesAndFeedbackToStep, answerableInfo, answerableSteps, confirmCorrectStep, hint, hintStepsByChoiceIndex, index, responseTemplate, runtimeActivity, step, steps, _i, _j, _len, _len2, _len3, _ref, _ref2, _results,
        _this = this;
      runtimeActivity = runtimePage.activity;
      ...
      _ref = [this.initialPrompt].concat(this.orderedHints);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        answerableInfo = _ref[_i];
        steps.push(step = runtimePage.appendStep());
        answerableSteps.push(step);
        if (answerableInfo !== this.initialPrompt) {
          hintStepsByChoiceIndex[answerableInfo.choiceIndex] = step;
        }
      ...
      for (index = 0, _len2 = answerableSteps.length; index < _len2; index++) {
        ...
        step.appendResponseBranch({
          criterion: this.getCriterionForCorrectAnswer(),
          step: confirmCorrectStep
        });
        _ref2 = this.orderedHints;
