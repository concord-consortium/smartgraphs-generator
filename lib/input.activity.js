  ...
  exports.Activity = Activity = (function() {
    function Activity(hash) {
      ...
      if (hash.type !== 'Activity') {
        throw new Error("smartgraphs-generator: input.Activity constructor was called with a hash whose toplevel\nelement does not have type: \"Activity\" ");
      }
      this.name = hash.name;
      this.pages = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          page = _ref[_i];
          _results.push(new Page(page, this));
        }
        return _results;
      }).call(this);
    }
