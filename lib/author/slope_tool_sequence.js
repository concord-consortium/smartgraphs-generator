(function() {
  ...
  exports.SlopeToolSequence = SlopeToolSequence = (function() {
    ...
    SlopeToolSequence.prototype.ending_text = function() {
      var axis_name_result;
      axis_name_result = " for " + this.x_axis_name;
      return "" + this.xMax + (this.xUnits.length > 0 ? this.xUnits : axis_name_result);
    };

    SlopeToolSequence.prototype.starting_text = function() {
      var unit_results;
      unit_results = "";
      if (this.xUnits.length > 0) unit_results = this.xUnits;
      return "" + this.xMin + " " + unit_results;
    };
