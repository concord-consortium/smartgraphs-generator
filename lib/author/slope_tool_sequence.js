  ...
  exports.SlopeToolSequence = SlopeToolSequence = (function() {
    ...
    SlopeToolSequence.prototype.appendSteps = function(runtimePage) {
      ...
      if (this.graphPane.xUnitsRef) {
        ...
        this.in_slope_units = " in " + slope_units;
      }
      ...
      runtimePage.addSlopeVars(this.firstPoint, this.secondPoint, this.tolerance);
    ...
    SlopeToolSequence.prototype.ask_for_slope = function() {
      return {
        ...
        submitButtonTitle: "Check My Answer",
        responseTemplate: "" + this.response_template + "/numeric",
        beforeText: "<p>If the change in " + this.y_axis_name + " is %@" + this.in_yUnits + "\n  and the change in " + this.x_axis_name + " is %@" + this.in_xUnits + "\n  then what is the " + this.slopeVariableName + this.in_slope_units + "?</p>",
    ...
    SlopeToolSequence.prototype.confirm_correct = function() {
      return {
        ...
        isFinalStep: true,
        hideSubmitButton: true,
        beforeText: "<p><b>Correct!</b></p>\n<p>The " + this.slopeVariableName + " is <b>%@</b>" + this.slope_units + ".</p>",
