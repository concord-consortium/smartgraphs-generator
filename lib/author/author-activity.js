...
(function() {
  ...
  exports.AuthorActivity = AuthorActivity = (function() {
    ...
    function AuthorActivity(hash) {
      ...
      this.name = hash.name, this.owner = hash.owner, this.authorName = hash.authorName, this.ccProjectName = hash.ccProjectName;
    ...
    AuthorActivity.prototype.toRuntimeActivity = function() {
      ...
      runtimeActivity = new RuntimeActivity(this.owner, this.name, this.authorName, this.ccProjectName, this.hash.datasets, this.hash.labelSets);
