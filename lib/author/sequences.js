(function() {
  ...
  Sequence.classFor['NumericSequence'] = NumericSequence = (function() {
    ...
    NumericSequence.prototype.appendSteps = function(runtimePage) {
      var addPanesAndFeedbackToStep, answerableInfo, answerableSteps, confirmCorrectStep, giveUpStep, index, lastAnswerableStep, responseTemplate, runtimeActivity, step, steps, _i, _len, _len2, _ref, _results;
      runtimeActivity = runtimePage.activity;
