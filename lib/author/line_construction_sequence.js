(function() {
  ...
  exports.LineConstructionSequence = LineConstructionSequence = (function() {
    ...
    LineConstructionSequence.prototype.check_correct_answer = function() {
        // TODO: This needs to be able to handle the nCounter value and direct to the proper step
        // See e.g. BestFitSequence.prototype.check_correct_answer
      return [
        {
    ...
    LineConstructionSequence.prototype.first_question = function() {
      return {
        name: "question",
        defaultBranch: this.maxAttempts == 1 ? "attempts_over" : "incorrect_answer_all",
    ...
    LineConstructionSequence.prototype.incorrect_answer_all = function(nCounter) {
        // TODO: Adapt for maxAttempts - name and defaultBranch - make this _after_try
      return {
        name: "incorrect_answer_all",
        defaultBranch:(nCounter + 1) < this.maxAttempts ? "incorrect_answer_all" : "attempts_over",
        submitButtonTitle: "Check My Answer",
    ...
    LineConstructionSequence.prototype.incorrect_answer_but_y_intercept_correct = function(nCounter) {
        // TODO: Adapt for maxAttempts - name and defaultBranch - make this _after_try
      return {
    ...
    LineConstructionSequence.prototype.attempts_over = function() {
        // TODO: This beforeText looks hardwired and wrong?
      return {
        name: "attempts_over",
        isFinalStep: true,
        hideSubmitButton: true,
        beforeText: "<b>Your line construction is incorrect.</b>",
        showCrossHairs: false,
    ...
    LineConstructionSequence.prototype.assemble_steps = function() {
      ...
      while(nCounter < this.maxAttempts) {
        this.steps.push(this.incorrect_answer_all(nCounter));
        this.steps.push(this.incorrect_answer_but_y_intercept_correct(nCounter));
        this.steps.push(this.incorrect_answer_but_slope_correct(nCounter));
        nCounter++;
      }
