(function() {
  ...
  exports.LineConstructionSequence = LineConstructionSequence = (function() {
    ...
    LineConstructionSequence.prototype.check_correct_answer = function(nCounter) {
        var criterionArray, nextSlopeCorrect, nextInterceptCorrect;
        criterionArray = [];
        if ((nCounter + 1) < this.maxAttempts) {
            nextSlopeCorrect = 'incorrect_answer_but_slope_correct_after_' + nCounter + '_try';
            nextInterceptCorrect = 'incorrect_answer_but_y_intercept_correct_after_' + nCounter + '_try';
            criterionArray = [
                {
